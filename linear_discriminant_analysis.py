...
# Like : 1, Dislike: 0
fruits_likes = np.array([ 1, 1, 1, 1, 0, 0, 0, 0 ])
...
print(f"Zehan will {'like' if predicted_like[0] == 1 else 'not like'} a fruit of size {new_fruit[ 0, 0 ]} and sweetness {new_fruit[ 0, 1 ]}.")